...
class TestResourceMatcher:
    ...
    def test_primary_match_by_id(self):
        ...
        iac_resources = [
            {"id": "ec2-456", "type": "aws_ec2_instance", "name": "db-server"},
            {"id": "ec2-123", "type": "aws_ec2_instance", "name": "web-server"},
        ]
    ...
    def test_primary_match_by_resource_id(self):
        ...
        iac_resources = [
            {"resource_id": "ec2-123", "type": "aws_ec2_instance", "name": "web-server"}
        ]
    ...
    def test_secondary_match_by_type_and_name(self):
        ...
        iac_resources = [
            {"id": "iac-456", "type": "aws_ec2_instance", "name": "web-server"}
        ]
    ...
    def test_secondary_match_by_resource_type(self):
        ...
        iac_resources = [
            {"id": "iac-456", "resourceType": "aws_ec2_instance", "name": "web-server"}
        ]
    ...
    def test_no_match_found(self):
        ...
        iac_resources = [
            {"id": "iac-456", "type": "aws_s3_bucket", "name": "my-bucket"}
        ]
